    ...
    return (
        <Card className={styles.card}>
            <div className={styles.card__header}>
                ...
                {label == '오늘의 천문사진' && <Telescope className="w-5 h-5 text-neutral-600"></Telescope>}
                {label == 'NASA 이미지 & 비디오 라이브러리' && <Rocket className="w-5 h-5 text-neutral-600"></Rocket>}
                {label == '지구 다색 이미징 카메라' && <Earth className="w-5 h-5 text-neutral-600"></Earth>}
            </div>
